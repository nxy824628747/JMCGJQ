...
public class SysDeptController extends BaseController
{
    ...
    @ResponseBody
    public List<Map<String, Object>> treeDataById()
    {
        Long deptId=getSysUser().getDeptId();
        String ancestors=deptService.selectAncestors(deptId);
        ancestors=ancestors+","+String.valueOf(deptId);
        List<Map<String, Object>> tree = deptService.selectTreeById(deptId,ancestors);
        return tree;
    }
