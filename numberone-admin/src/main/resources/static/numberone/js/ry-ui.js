...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            removeReal: function (id) {
                $.modal.confirm("物理删除后数据不可找回，确定物理删除该条" + $.table._option.modalName + "信息吗？", function () {
                    var url = $.common.isEmpty(id) ? $.table._option.removeRealUrl : $.table._option.removeRealUrl.replace("{id}", id);
                    var data = {"ids": id};
                    $.operate.submit(url, "post", "json", data);
                });
            },
        ...
        common: {
            ...
            gettime: function (value) {
                ...
                var time = nowTime.substring(11, 20);
                return time;
            },
