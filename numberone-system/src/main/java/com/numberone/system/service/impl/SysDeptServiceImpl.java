...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    /**
     * 根据部门id查询祖先id（多个祖先id间逗号隔开）
     * @param deptId
     * @return
     */
    @Override
    public String selectAncestors(Long deptId){
     ...
     */
    @Override
    public List<SysDept> selectSonTree(Long deptId){
        return deptMapper.selectSonTree(deptId);
    }

    /**
     * 根据当前账号所属部门查询上级及下级部门树
     * @param deptId 部门id
     * @param ancestors 祖先id（逗号隔开）
     * @return
     */
    @Override
    public List<Map<String, Object>> selectTreeById(Long deptId,String ancestors){
        List<Map<String, Object>> trees = new ArrayList<Map<String, Object>>();
        List<SysDept> deptList = deptMapper.selectTreeById(ancestors);;
        List<SysDept> sonList = deptMapper.selectSonTree(deptId);
        deptList.addAll(sonList);
        trees = getTrees(deptList, false, null);
        return trees;
    };
